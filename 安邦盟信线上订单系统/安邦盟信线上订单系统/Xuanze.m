...
- (void)viewDidLoad {
    ...
    self.sou.delegate=self;
    [_sou setTranslucent:YES];
    [_sou setSearchResultsButtonSelected:NO];
    [_sou setTintColor:[UIColor clearColor]];
    [_sou setShowsCancelButton:YES animated:YES];
